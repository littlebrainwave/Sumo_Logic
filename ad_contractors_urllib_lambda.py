...
def lambda_handler(event, context):
    ...
    searchJob = {
        "query": "cat path://\"/Library/Users/X/Lookups/All Contractor AD Groups\"",
        "from": from_time_str,
        "to": to_time_str,
        "timeZone": "CST"
    }
    ...
    def save_results_to_file(searchjobid):
        ...
        try:
            ...
            if r.status == 200:
                with open("/tmp/Contractor_AD_Users.txt", "w") as file:
    ...
    def save_extracted_usernames(usernames):
        ...
        with open("/tmp/contractor_criticality.json", "w") as file:
    ...
    def post_extracted_usernames():
        ...
        try:
            with open("/tmp/contractor_criticality.json", "r") as file:
    ...
    with open("/tmp/Contractor_AD_Users.txt", "r") as file:
